...
public class ReadData {
    ...
    public static List<Course> readCourse() throws Exception {
        List<String> lineList = readLine("C:\\Users\\ASUS\\Desktop\\Project\\CourseOffering.csv");
        ...
        for(int T = 0; T < lineList.size(); T++) {
            ...
            if(lineSplit[5].equals("Yes")) isOnline = true;
            else isOnline = false;
    ...
    public static List<Room> readRoom() throws Exception {
        List<String> lineList = readLine("C:\\Users\\ASUS\\Desktop\\Project\\Room.csv");
    ...
    public static List<ClassTime> readClassTime() throws Exception {
        List<String> lineList = readLine("C:\\Users\\ASUS\\Desktop\\Project\\Time.csv");
